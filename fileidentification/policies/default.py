...
default_policies = {
    ...
    "x-fmt/21": {
        "format_name": "7-bit ANSI Text",
        "bin": Bin.EMPTY,
        "accepted": True
    },
    "x-fmt/22": {
        "format_name": "7-bit ASCII Text",
        "bin": Bin.EMPTY,
        "accepted": True
    },
    "x-fmt/111": {
    ...
    "x-fmt/282": {
        "format_name": "8-bit ANSI Text",
        "bin": Bin.EMPTY,
        "accepted": True
    },
    "x-fmt/62": {
        "format_name": "Log File",
        "bin": Bin.EMPTY,
        "accepted": True
    },
    "fmt/101": {
